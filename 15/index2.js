...
function main() {
    ...
    // 变量primitives 来源于另一个脚本 primitives.js
    ...
    function drawScene(time) {
      ...
      console.log('sun',sunNode.localMatrix)
      // console.log('earthNode',earthNode.localMatrix)
      // console.log('earthNode',earthNode.localMatrix)
  
      // Update all world matrices in the scene graph
      sunNode.updateWorldMatrix();
      console.log('sun worldMatrix:',sunNode.worldMatrix)
      // console.log('earthNode worldMatrix:',earthNode.worldMatrix)
      // console.log('earthNode worldMatrix:',earthNode.worldMatrix)
      // debugger
